...
class ChainlitConfiguration(BaseConfiguration):
    ...
    disclaimer_text: str = Field(
        "This content is AI-generated and may contain inaccuracies. Please verify any critical information independently. Additional details, including imprint and privacy policy information, can be found in the **Readme file located at he top-right corner of the page.**",
