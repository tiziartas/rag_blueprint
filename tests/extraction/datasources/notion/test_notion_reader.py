...
from extraction.datasources.notion.exporter import NotionExporter
from extraction.datasources.notion.reader import NotionDatasourceReader
...
class Arrangements:
    ...
    def __init__(self, fixtures: Fixtures) -> None:
        ...
        self.service = NotionDatasourceReader(
    ...
    def on_get_ids_from_home_page_return_ids(self) -> "Arrangements":
        NotionDatasourceReader._get_ids_from_home_page = Mock(
            return_value=(
...
class Manager:
    ...
    def get_service(self) -> NotionDatasourceReader:
        return self.arrangements.service


class TestNotionDatasourceReader:
    ...
    async def test(
        ...
        # Act
        all_documents = await service.read_all_async()
