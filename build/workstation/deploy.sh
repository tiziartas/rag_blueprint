...
# ===============================================================
# RAG Blueprint Deployment Script
# ===============================================================
# Purpose: Deploys the RAG Blueprint application to specified environment
# Usage: ./deploy.sh --env <environment_name>
# Example: ./deploy.sh --env dev
# ===============================================================
...
if [ "$1" = "--env" ] && [ -n "$2" ]; then
    ...
    echo "Please provide the environment name as an argument. E.g. './deploy.sh --env dev'"
    exit 1
fi
...
# Creating unique build name based on current timestamp
...
# Check if UV package installer is available
...
# Run deployment in background process with logging
